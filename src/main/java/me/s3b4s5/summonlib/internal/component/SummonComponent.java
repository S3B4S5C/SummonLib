package me.s3b4s5.summonlib.internal.component;
...
/**
 * Internal ECS component used to mark summon entities and track per-owner ordering.
 * Not part of the supported public API.
 */
public final class SummonComponent implements Component<EntityStore> {
    ...
    public SummonComponent(UUID owner, String summonId, int slotCost, long spawnSeq, int variantIndex) {
        this();
        this.owner = owner;
    ...
    public SummonComponent(SummonComponent o) {
        this.owner = o.owner;
